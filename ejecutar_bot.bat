...
REM Usar un --user-data-dir propio evita el conflicto con las ventanas de Chrome
REM normales (no hace falta cerrarlas) y hace que la sesion quede guardada entre
REM corridas: solo hace falta iniciar sesion la primera vez.
...
echo   Si la sesion no estaba iniciada antes en este perfil, iniciarla
echo   MANUALMENTE en la ventana de Chrome que se abrio (usuario
echo   y contrasena). El bot nunca ve la clave.
echo   Si ya habia una sesion iniciada de una corrida anterior, solo
echo   verificar que la pagina cargo bien y presionar una tecla.
echo ============================================================
echo.
pause

REM --- Paso 2: pedir el archivo Excel de entrada ---
set /p EXCEL_INPUT="[2/3] Arrastrar aqui el archivo Excel de entrada y presionar Enter: "
if "!EXCEL_INPUT!"=="" (
...
echo.
echo ============================================================
echo   Listo. Revisar reporte.xlsx en esta misma carpeta.
echo ============================================================
pause
